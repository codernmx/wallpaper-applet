<template>
	<view>
		<view class="u-p-40">
			...
			<view class="cont">
				A.您确认，在您开始使用/注册星潮图馆服务前，您应当具备中华人民共和国法律规定的与您行为相适应的民事行为能力。若您不具备前述与您行为相适应的民事行为能力，则应获得监护人的知情同意，您及您的监护人应依照法律规定承担因此而导致的相应的责任。特别地，如果您是未成年人，请在您的监护人的同意和指导下访问和/或使用我方应用服务。
			</view>
			<view class="cont">
			...
			<view class="cont">
				如果封面存在版权问题，星潮图馆官方有权在不告知您的情况下删除封面；
			</view>
			<view class="cont">
				当您上传封面后，星潮图馆官方可能会在不告知您的情况下以署名的形式将封面发布到其他渠道，比如微信公众号等
			</view>
		</view>
	</view>
</template>
